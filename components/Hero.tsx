            ...
            <div className="flex items-center justify-between h-16 lg:h-20">
              <div className="flex-shrink-0 items-center">
                <a href="#" title="" className="flex items-center">
                  <p className="w-auto h-8 text-green-300 font-bold text-xl">
                    Slate Editor
                  </p>
                </a>
              </div>
            ...
            <div className="max-w-xl mx-auto text-center">
              <h1 className="text-4xl font-bold sm:text-6xl">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white">
                  {" "}
                  Simplified text Editor for everyone{" "}
                </span>
              </h1>
              <p className="mt-5 text-base text-white sm:text-xl">
                Craft, format, and fine-tune your words with a seamless,
                intuitive editor built to help you create effortlessly.
              </p>
              ...
              <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                <div className="flex items-center">
                  ...
                  <p className="ml-3 text-sm text-white">Easy Formatting</p>
                </div>
